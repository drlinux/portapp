...
class Garanti
{
	...
	public $secure3dsecuritylevel = '3D_PAY';//3D_PAY, 3D_FULL, 3D_HALF
	public $cardnumber;
	...
	public function tds_data()
	{
		...
		"txncurrencycode=$this->txncurrencycode&".
		"txninstallmentcount=$this->txninstallmentcount&".
		...
		"secure3dhash=".$this->getSecure3dhash();
	}
	...
	{
		$SecurityData = strtoupper(sha1($this->provisionPassword.$this->terminalid_));
		return strtoupper(sha1($this->terminalid.$this->orderid.$this->txnamount.$this->successurl.$this->errorurl.$this->txntype.$this->txninstallmentcount.$this->storeKey.$SecurityData));
	}
