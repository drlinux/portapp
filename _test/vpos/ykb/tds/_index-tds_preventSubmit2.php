...
<script language="JavaScript" src="posnet.js"></script>
<script>
...
<input name="merchantReturnURL" type="hidden" id=" merchantReturnURL" value="https://www.bedenozgurlugu.com/tds/provision-tds.php">
