...
$name		= "CEM";//is yeri kullanic adi
$password	= "Z1q2w3e4r";//Is yeri sifresi
$clientid	= $_POST["clientid"];//Banka tarafindan verilen is yeri numarasi
...
$oid= $_POST['oid'];//Siparis numarası her islem icin farkli olmalidir, bos gonderilirse sistem bir siparis numarasi üretir.
...
$mdStatus=$_POST['mdStatus'];       // 3d Secure i�leminin sonucu mdStatus 1,2,3,4 ise ba�ar�l� 5,6,7,8,9,0 ba�ar�s�zd�r
                                    // 3d Decure i�leminin sonucu ba�ar�s�z ise i�lemi provizyona g�ndermeyiniz (XML g�ndermeyiniz).
$xid=$_POST['xid'];                 // 3d Secure �zel alani PayerTxnId
$eci=$_POST['eci'];                 // 3d Secure �zel alani PayerSecurityLevel
$cavv=$_POST['cavv'];               // 3d Secure �zel alani PayerAuthenticationCode
$md=$_POST['md'];                   // E�er 3D i�lemba�ar�l�sya provizyona kart numaras� yerine md de�eri g�nderilir.
...
{ 	
	...
	$url = "https://ccpos.garanti.com.tr/servlet/cc5ApiServer";  //TEST
	...
	// Buraya mdStatusa g�re bir kontrol koymalisiniz.
	// 3d Secure i�leminin sonucu mdStatus 1,2,3,4 ise ba�ar�l� 5,6,7,8,9,0 ba�ar�s�zd�r
	// 3d Decure i�leminin sonucu ba�ar�s�z ise i�lemi provizyona g�ndermeyiniz (XML g�ndermeyiniz).
...
<?php
	...
	{
		echo "Ödeme isleminiz gerçeklestirilmedi. Hata=" . $ErrMsg;
	}
