...
<title>{$smarty.const.PRIVATESHOP_TITLE}</title>
...
<!-- STYLES -->
<link href="modules/privateshop/css/style.css" rel="stylesheet" type="text/css" media="screen" />
...
<div id="container">
	<div id="navigation">
		<span class="buttonset fr">
			<button cas-js="getBreadcrumbsIso639" cas:url="modules/privateshop/index.php" cas:uri="{$PROJECT_ENCODEDURI}"></button>
			<button cas-js="getLoginoutButton" cas:url="modules/privateshop/index.php"></button>
		</span>
	</div>
	<div id="header">
		<h1>privateshop</h1>
		<h2>privateshopping</h2>
	</div>
	<div id="wrapper">
		<!--
		<div id="content">
	...
	<div id="footer">
		...
		Copyright &copy; 2011 {$smarty.const.PRIVATESHOP_TITLE}. {#LABEL_AllRightsReserved#}.
	</div>
</div>
