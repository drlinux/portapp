	...
	<div data-role="content">
		<div class="content-primary">
			<ul data-role="listview" data-filter="true"
				data-filter-placeholder="Search people..." data-filter-theme="b">
		...
		<div class="content-secondary">
			...
			<div data-role="collapsible" data-collapsed="true" data-theme="b"
				...
				<ul data-role="listview" data-theme="c" data-dividertheme="d">
					...
					<li><a href="lists-search-inset.html">Inset search filter
							bar</a></li>
					<li data-theme="a"><a href="lists-search-with-dividers.html">Search
							filter bar with dividers</a></li>

					<li><a href="lists-readonly.html">Read-only lists</a></li>
					<li><a href="lists-readonly-inset.html">Read-only inset
							lists</a></li>
					<li><a href="lists-forms.html">Lists with forms</a></li>
					<li><a href="lists-forms-inset.html">Inset lists with
							forms</a></li>
