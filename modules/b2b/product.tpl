...
<div class="casContent">
	...
	<ul class="productsList bigProductList" cas-js="getProductsSimilar" cas:url="modules/b2b/index.php" cas:var="{$data.category.defaultx.categoryId}" cas:limit="{$_THEME_B2B_LIMITPRODUCTS1}" cas-break="{$_THEME_B2B_NUMBEROFPRODUCTSDISPLAYED}">
