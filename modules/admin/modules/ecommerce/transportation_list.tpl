...
$(document).ready(function() {
	$('#example').dataTable( {
		...
		"fnRowCallback": function( nRow, aData, iDisplayIndex ) {
			//if (aData[1] != null) $('td:eq(0)', nRow).html( '<img src="img/transportation/100/' + aData[1] + '" />' );
			$('td:eq(0)', nRow).html( '<a href="{$SCRIPT_NAME}?action=edit&transportationId=' + aData[0] + '">' + aData[1] + '</a>' );
			return nRow;
		},
		"oLanguage": {
			"oPaginate": {
