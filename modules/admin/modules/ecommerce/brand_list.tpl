...
$(document).ready(function() {
	$('#example').dataTable( {
		...
		"fnRowCallback": function( nRow, aData, iDisplayIndex ) {
			$('td:eq(0)', nRow).html( '<a href="{$SCRIPT_NAME}?action=edit&brandId=' + aData[0] + '">' + aData[1] + '</a>' );
			if (aData[2] != null) $('td:eq(2)', nRow).html( '<a href="{$SCRIPT_NAME}?action=edit&brandId=' + aData[0] + '"><img src="img/brand/100/' + aData[3] + '" /></a>' );
			return nRow;
		},
		"oLanguage": {
			"oPaginate": {
