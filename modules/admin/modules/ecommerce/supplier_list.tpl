...
$(document).ready(function() {
	$('#example').dataTable( {
		...
		"fnRowCallback": function( nRow, aData, iDisplayIndex ) {
			$('td:eq(0)', nRow).html( '<a href="{$SCRIPT_NAME}?action=edit&supplierId=' + aData[0] + '">' + aData[1] + '</a>' );
			//if (aData[2] != null) $('td:eq(1)', nRow).html( '<a href="{$SCRIPT_NAME}?action=edit&supplierId=' + aData[0] + '"><img src="img/supplier/100/' + aData[2] + '" /></a>' );
			return nRow;
		},
		"oLanguage": {
			"oPaginate": {
