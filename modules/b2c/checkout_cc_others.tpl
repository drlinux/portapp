<div class="areaHeader">
	<span class="museo500">Sipariş Ayrıntıları</span>
</div>

<p>Ödeme Şekli: {$data.payment.paymentgroup.paymentgroupTitle}</p>
<p>Taşıma: {$data.transportation.transportationTitle}</p>
<p>Teslimat Adresi: {$data.deliveryaddress.postaladdressContent}, {$data.deliveryaddress.postaladdressCity}, {$data.deliveryaddress.postaladdressCounty}, {$data.deliveryaddress.postaladdressPostalcode}, {$data.deliveryaddress.postaladdressCountry}</p>
<p>Fatura Adresi: {$data.invoiceaddress.postaladdressContent}, {$data.invoiceaddress.postaladdressCity}, {$data.invoiceaddress.postaladdressCounty}, {$data.invoiceaddress.postaladdressPostalcode}, {$data.invoiceaddress.postaladdressCountry}</p>
<p>Tutar: {$data.amountRealWC}</p>
<p>Taksit Sayısı: {$data.payment.paymentPeriod}</p>

<div class="areaHeader">
	<span class="museo500">Ödeme</span>
</div>
<p>{$data.payment.paymentgroup.paymentgroupContent}</p>
