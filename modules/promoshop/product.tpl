<div id="sidebar">
	<h1>{#LABEL_Product#}</h1>
	<p id="trackingString" >
		<a href="modules/promoshop/index.php">ANA SAYFA</a>
		&gt;
		<a href="modules/promoshop/index.php?type=category&categoryId={$data.category.defaultx.categoryId}">{$data.category.defaultx.categoryTitle}</a>
		&gt;
