...
<html>
	<head>
		...
		<link rel="stylesheet" href="assets/plugins/nivo-slider/themes/default/default.css" />
		...
		<!-- STYLES -->
		<link rel="stylesheet" href="{$smarty.const._THEMES_DIR_}b2c/{$_THEME_B2C_NAME}/css/style.css" />
		<!--[if IE 7]>
	        <link rel="stylesheet" type="text/css" href="{$smarty.const._THEMES_DIR_}b2c/{$_THEME_B2C_NAME}/css/ie7.css" />
		<![endif]-->
		<!--[if IE 8]>
	        <link rel="stylesheet" type="text/css" href="{$smarty.const._THEMES_DIR_}b2c/{$_THEME_B2C_NAME}/css/ie8.css" />
		<![endif]-->
		
		<script type="text/javascript" src="{$smarty.const._THEMES_DIR_}b2c/{$_THEME_B2C_NAME}/js/master.js" ></script>
